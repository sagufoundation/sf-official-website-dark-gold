(function () {
  ...
  function injectHeaderPartial() {
    ...
    if (!document.getElementById('sf-header-partial-style')) {
      ...
      style.textContent = [
        '.sfh-header{position:fixed;top:0;left:0;right:0;z-index:99999;background:#000;border-bottom:1px solid rgba(255,255,255,.12);font-family:"Plus Jakarta Sans",sans-serif;}',
        ...
        '.sfh-main{min-height:72px;display:flex;align-items:center;justify-content:space-between;gap:12px;padding:10px 0;}',
        '.sfh-brand{text-decoration:none;color:#fff;display:flex;align-items:center;gap:12px;min-width:0;flex:1;}',
        '.sfh-brand img{height:46px;width:auto;object-fit:contain;flex-shrink:0;}',
        '.sfh-brand-name{font-size:18px;font-weight:800;line-height:1.1;white-space:normal;}',
        '.sfh-brand-tag{font-size:12px;color:#e6a817;line-height:1.1;white-space:normal;}',
        ...
        '.sfh-mega-menu{position:absolute;left:50%;top:100%;width:min(1232px,calc(100vw - 48px));transform:translateX(-50%) translateY(8px);background:#000;border:1px solid rgba(255,255,255,.12);border-radius:12px;padding:14px;box-shadow:0 24px 50px rgba(0,0,0,.45);opacity:0;visibility:hidden;pointer-events:none;transition:all .2s ease;z-index:1;}',
        '.sfh-mega-menu::before{content:\"\";position:absolute;left:0;right:0;top:-14px;height:14px;}',
        '.sfh-topbar .sfh-mega-menu{top:34px;}',
        '.sfh-topbar .sfh-mega-menu::before{top:-20px;height:20px;}',
        ...
        '.sfh-mega-3col{display:grid;grid-template-columns:repeat(3,1fr);gap:16px;}',
        '.sfh-mega-catcard{display:block;text-decoration:none;background:#151515;border:1px solid rgba(255,255,255,.1);border-radius:10px;overflow:hidden;transition:border-color .2s ease,transform .2s ease;margin-bottom:10px;}',
        '.sfh-mega-catcard:hover{border-color:rgba(230,168,23,.6);transform:translateY(-2px);}',
        '.sfh-mega-catcard::after{display:none !important;}',
        '.sfh-mega-catcard img{width:100%;aspect-ratio:5/3;object-fit:cover;display:block;filter:grayscale(30%);transition:filter .3s ease;}',
        '.sfh-mega-catcard:hover img{filter:grayscale(0%);}',
        '.sfh-mega-catcard-body{padding:10px 12px;}',
        '.sfh-mega-catcard-title{display:block;color:#fff;font-size:14px;font-weight:700;line-height:1.3;}',
        '.sfh-mega-catcard-badge{display:inline-block;font-size:10px;font-weight:700;color:#e6a817;background:rgba(230,168,23,.15);padding:2px 8px;border-radius:999px;margin-top:4px;text-transform:uppercase;letter-spacing:.05em;}',
        '.sfh-mega-subcol{border-top:1px solid rgba(255,255,255,.08);padding-top:8px;}',
        '.sfh-mega-subcol a{display:flex;align-items:center;gap:7px;padding:5px 6px;border-radius:6px;font-size:12px;font-weight:500;color:#c7c7c7;text-decoration:none;}',
        '.sfh-mega-subcol a:hover{color:#e6a817;background:rgba(255,255,255,.05);}',
        '.sfh-mega-subcol a::after{display:none !important;}',
        '.sfh-mega-subcol-desc{font-size:12px;color:#a6a6a6;line-height:1.5;padding:4px 6px;}',
        ...
        '@media (max-width:1023px){.sfh-wrap{padding:0 16px;}.sfh-main{min-height:64px;padding:10px 0;}.sfh-brand{gap:10px;}.sfh-brand img{height:40px;}.sfh-brand-name{font-size:15px;}.sfh-brand-tag{font-size:10px;display:block;}.sfh-nav{display:none;}.sfh-mobile-toggle{display:inline-flex;}.sfh-mobile-panel{display:none;}.sfh-mobile-panel.open{display:block;}}',
        '@media (max-width:640px){.sfh-wrap{padding:0 14px;}.sfh-brand{gap:8px;}.sfh-brand img{height:36px;}.sfh-brand-name{font-size:14px;}.sfh-brand-tag{display:none;}.sfh-breadcrumb-inner{align-items:flex-start;}.sfh-breadcrumb-cta{font-size:11px;padding:6px 10px;}}',
    ...
    wrapper.innerHTML = [
      ...
      '          <a href="what-we-do.html" data-top-target="what-we-do.html">What We Do <i class="fa-solid fa-chevron-down" style="font-size:9px;margin-left:3px;"></i></a>',
      '          <div class="sfh-mega-menu">',
      '            <div class="sfh-mega-3col">',
      '              <div>',
      '                <a href="what-we-do.html" class="sfh-mega-catcard">',
      '                  <div class="sfh-mega-catcard-body" style="display:flex;align-items:center;gap:10px;">',
      '                    <i class="fa-solid fa-graduation-cap" style="color:#e6a817;font-size:18px;"></i>',
      '                    <span class="sfh-mega-catcard-title">Education</span>',
      '                  </div>',
      '                </a>',
      '                <div class="sfh-mega-subcol">',
      '                  <a href="program-detail.html?id=general-english">General English</a>',
      '                  <a href="program-detail.html?id=english-for-young-learners">English for Young Learners (EYL)</a>',
      '                  <a href="program-detail.html?id=ielts-preparation">IELTS Preparation</a>',
      '                  <a href="program-detail.html?id=toefl-preparation">TOEFL Preparation</a>',
      '                  <a href="program-detail.html?id=ielts-simulation-test">IELTS/TOEFL Simulation Test</a>',
      '                  <a href="program-detail.html?id=computer-literacy">Computer Literacy</a>',
      '                  <a href="program-detail.html?id=sagu-scholarship-club">Scholarship Club</a>',
      '                </div>',
      '              </div>',
      '              <div>',
      '                <a href="what-we-do.html" class="sfh-mega-catcard">',
      '                  <div class="sfh-mega-catcard-body" style="display:flex;align-items:center;gap:10px;">',
      '                    <i class="fa-solid fa-briefcase" style="color:#e6a817;font-size:18px;"></i>',
      '                    <span class="sfh-mega-catcard-title">Workforce Development</span>',
      '                  </div>',
      '                </a>',
      '                <div class="sfh-mega-subcol">',
      '                  <a href="program-detail.html?id=english-for-specific-purposes">English for Specific Purposes (ESP)</a>',
      '                  <a href="program-detail.html?id=professional-training-workshops">Professional Training &amp; Workshops</a>',
      '                  <a href="program-detail.html?id=internship">Internship Programme</a>',
      '                  <a href="program-detail.html?id=community-development">Community Development Programme</a>',
      '                </div>',
      '              </div>',
      '              <div>',
      '                <a href="what-we-do.html" class="sfh-mega-catcard">',
      '                  <div class="sfh-mega-catcard-body" style="display:flex;align-items:center;gap:10px;">',
      '                    <i class="fa-solid fa-magnifying-glass" style="color:#e6a817;font-size:18px;"></i>',
      '                    <span class="sfh-mega-catcard-title">Research</span>',
      '                  </div>',
      '                </a>',
      '                <div class="sfh-mega-subcol">',
      '                  <a href="program-detail.html?id=programme-evaluation">Programme Evaluation</a>',
      '                  <a href="program-detail.html?id=research-projects">Research Projects</a>',
      '                  <a href="program-detail.html?id=publications">Publications</a>',
      '                </div>',
      '              </div>',
      '            </div>',
      '          </div>',
      '        </div><span class="sfh-divider">|</span>',
      ...
      '            <div class="sfh-mega-3col">',
      '              <div>',
      '                <a href="comdev.html" class="sfh-mega-catcard" data-nav-target="comdev.html">',
      '                  <img src="images/programs/program-community-development.png" alt="Community Development">',
      '                  <div class="sfh-mega-catcard-body">',
      '                    <span class="sfh-mega-catcard-title">Community Development</span>',
      '                  </div>',
      '                </a>',
      '                <div class="sfh-mega-subcol">',
      '                  <a href="program-detail.html?id=tutor-led-comdev-projects"><i class="fa-solid fa-chalkboard-user" style="color:#e6a817;font-size:10px;width:14px;text-align:center;"></i>Tutor-led ComDev Projects</a>',
      '                  <a href="program-detail.html?id=sagu-visits-schools"><i class="fa-solid fa-school" style="color:#e6a817;font-size:10px;width:14px;text-align:center;"></i>SAGU Visits Schools</a>',
      '                  <a href="program-detail.html?id=sagu-visits-communities"><i class="fa-solid fa-house-chimney-user" style="color:#e6a817;font-size:10px;width:14px;text-align:center;"></i>SAGU Visits Communities</a>',
      '                  <a href="program-detail.html?id=sagu-scholarship-club"><i class="fa-solid fa-award" style="color:#e6a817;font-size:10px;width:14px;text-align:center;"></i>SAGU Scholarship Club</a>',
      '                </div>',
      '              </div>',
      '              <div>',
      '                <a href="program-detail.html?id=internship" class="sfh-mega-catcard">',
      '                  <img src="images/programs/program-internship.png" alt="Internship">',
      '                  <div class="sfh-mega-catcard-body">',
      '                    <span class="sfh-mega-catcard-title">Internship</span>',
      '                  </div>',
      '                </a>',
      '                <div class="sfh-mega-subcol">',
      '                  <p class="sfh-mega-subcol-desc">Hands-on experience in real projects for students and young professionals contributing to education and community development in Papua.</p>',
      '                </div>',
      '              </div>',
      '              <div>',
      '                <a href="courses.html" class="sfh-mega-catcard" data-nav-target="courses.html">',
      '                  <img src="images/programs/SAGU-Foundation-General-English-2-500x300.png" alt="Courses">',
      '                  <div class="sfh-mega-catcard-body">',
      '                    <span class="sfh-mega-catcard-title">Courses</span>',
      '                  </div>',
      '                </a>',
      '                <div class="sfh-mega-subcol">',
      '                  <a href="program-detail.html?id=general-english"><i class="fa-solid fa-comments" style="color:#e6a817;font-size:10px;width:14px;text-align:center;"></i>General English</a>',
      '                  <a href="program-detail.html?id=ielts-preparation"><i class="fa-solid fa-graduation-cap" style="color:#e6a817;font-size:10px;width:14px;text-align:center;"></i>IELTS Preparation</a>',
      '                  <a href="program-detail.html?id=toefl-preparation"><i class="fa-solid fa-graduation-cap" style="color:#e6a817;font-size:10px;width:14px;text-align:center;"></i>TOEFL Preparation</a>',
      '                  <a href="program-detail.html?id=computer-literacy"><i class="fa-solid fa-desktop" style="color:#e6a817;font-size:10px;width:14px;text-align:center;"></i>Computer Literacy</a>',
      '                </div>',
      '              </div>',
      '            </div>',
      '          </div>',
      ...
      '          </div>',
      '        </div>',
      '        <a href="courses.html" data-nav-target="courses.html">Courses</a>',
      '        <a href="blog.html" data-nav-target="blog.html">Blog</a>',
      ...
      '          <a href="comdev.html" data-nav-target="comdev.html">Community Development</a>',
      '          <a href="program-detail.html?id=tutor-led-comdev-projects" style="padding-left:20px;font-size:13px;">↳ Tutor-led ComDev Projects</a>',
      '          <a href="program-detail.html?id=sagu-visits-schools" style="padding-left:20px;font-size:13px;">↳ SAGU Visits Schools</a>',
      '          <a href="program-detail.html?id=sagu-visits-communities" style="padding-left:20px;font-size:13px;">↳ SAGU Visits Communities</a>',
      '          <a href="program-detail.html?id=sagu-scholarship-club" style="padding-left:20px;font-size:13px;">↳ SAGU Scholarship Club</a>',
      '          <a href="program-detail.html?id=internship">Internship</a>',
      '          <a href="courses.html" data-nav-target="courses.html">Courses</a>',
      '        </details>',
      '        <details>',
